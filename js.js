...
const typed = new Typed('.multiple-text', {
    strings: ['Especialista en climatizacion HVAC.', 'Reparaciones de calderas murales, BAXI, CALDAIA, LG.', 'Tecnico en refrigeracion trifasica y monofasica con tecnologia inverter.', ' Desarrollo web Front-End Developer.', 'Marketing digital y Desarrollo de contenidos .', 'Agente comercial, gestiones adminstrativas y cobranzas.', 'Solidas habilidades en atención al cliente.'],
    typeSpeed: 100,
    BackSpeed: 200,
    backDelay: 1000,
    loop: true
